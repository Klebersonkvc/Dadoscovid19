...
Original file is located at
    https://colab.research.google.com/drive/1JUhO638Z7-N3qOMHxOLYGpXTUmsInFwM
"""
...
print('Nessa aplicação, o usuário tem a opção de escolher o estado e o tipo de informação para mostrar o gráfico. Utilize o menu lateral para análise.')
